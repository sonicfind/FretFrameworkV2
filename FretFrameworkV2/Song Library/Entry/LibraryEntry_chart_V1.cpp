	...
	while (reader.isStartOfTrack())
	{
		const auto ScanTrack = [&](ChtFileReader::NoteTracks_V1 track) {
			...
			case ChtFileReader::Drums:
				...
				case DrumType_Enum::FOURLANE_PRO: return ChartV1_Scan::Scan<DrumNote<DrumPad_Pro, 4>>(m_scanTracks.drums4_pro, reader);
				case DrumType_Enum::FIVELANE:     return ChartV1_Scan::Scan<DrumNote<DrumPad, 5>>(m_scanTracks.drums5, reader);
				}
