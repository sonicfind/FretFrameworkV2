...
struct Midi_Scanner_Instrument::Scanner_Lanes<GuitarNote_Pro<numFrets>> {};

template <>
constexpr std::pair<unsigned char, unsigned char> Midi_Scanner_Instrument::Scanner_Diff<GuitarNote_Pro<17>>::NOTERANGE{ 24, 106 };

template <>
constexpr std::pair<unsigned char, unsigned char> Midi_Scanner_Instrument::Scanner_Diff<GuitarNote_Pro<22>>::NOTERANGE{ 24, 106 };
...
namespace Midi_Scan_ProGuitar
{
	...
	bool ParseColor(Midi_Scanner_Instrument::Scanner_Diff<GuitarNote_Pro<numFrets>>& diff, size_t noteValue, unsigned char channel, unsigned char velocity)
	{
