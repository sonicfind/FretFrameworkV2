...
private:
	struct Midi_Tracker_Vocal
	{
		...
		Midi_Tracker_Vocal(unsigned char star) : starPowerNote(star) {}
	};
...
private:
	...
	void parseNote(Midi_Tracker_Vocal& tracker, unsigned char midiValue, uint32_t position)
	{
	...
	template <size_t INDEX, bool NoteOn>
	void parseVocal(Midi_Tracker_Vocal& tracker, unsigned char pitch, uint32_t position)
	{
